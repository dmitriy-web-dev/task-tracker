...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // Auth gates for: TaskStatus
        Gate::define('taskstatus_access', function ($user) {
            return in_array($user->role_id, [1]);
        });
        Gate::define('taskstatus_create', function ($user) {
            return in_array($user->role_id, [1]);
        });
        Gate::define('taskstatus_view', function ($user) {
            return in_array($user->role_id, [1]);
        });
